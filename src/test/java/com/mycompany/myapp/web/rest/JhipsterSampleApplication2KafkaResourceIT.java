...
class JhipsterSampleApplication2KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleApplication2KafkaResource kafkaResource = new JhipsterSampleApplication2KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-application-2-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-application-2-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
